...
const Lockable_1 = __importDefault(require("./view/Lockable"));
...
(async () => {
    ...
    skyrouter_1.SkyRouter.route(["my-cases", "my-cases/{caseId}"], MyCases_1.default);
    skyrouter_1.SkyRouter.route("my-cases/{caseId}/lockable", Lockable_1.default);
