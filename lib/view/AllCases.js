...
class AllCases {
    constructor() {
        ...
        }))))), (0, skynode_1.el)(".properties", (0, skynode_1.el)("h4.section-title", "Properties"), ...Object.entries(rarity_json_1.default.traits).map(([key, values]) => (0, skynode_1.el)("select", {
            placeholder: key,
            change: (event, select) => {
        ...
        }, (0, skynode_1.el)("option", key, { value: "" }), ...Object.keys(values).filter((value) => value !== "").map((value) => (0, skynode_1.el)("option", value, { value }))))), this.caseList = (0, skynode_1.el)(".case-list")));
        this.loadCases();
    }
    loadCases() {
        const tokens = [];
        ...
        for (const [index, info] of tokens.entries()) {
            if (index >= (this.page - 1) * 300 && index < this.page * 300) {
                this.caseList.append((0, skynode_1.el)(".case", (0, skynode_1.el)("h5", `Case #${info.id}`), (0, skynode_1.el)("p", info.token.text)));
            }
        }
    }
